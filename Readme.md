...
If you work with HTN planning and the SHOP3 planner, this repository is for you and might serve as idea impulses and template. This repostiory contains older code from 2020 and is not maintained. SHOP3 is still the actual version, but has been maintained frequently since then, meaning there is no guarantee that the code will still work, but I hope I can give you some idea inputs.<br /><br />
