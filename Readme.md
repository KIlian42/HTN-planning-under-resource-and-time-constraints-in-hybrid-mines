...
If you work with HTN planning and the SHOP3 planner, this repository is for you and might serve as idea impulses and template. However, the repostiory containts is older and code from 2020, SHOP3 is still the current version, but has been maintained frequently, so there is no guarantee that there might be SHOP3 version depending bugs.<br /
...
SHOP3 documentation: https://shop-planner.github.io <br />
